    ...
    return (
        <div className="container mx-auto py-6 px-4 md:px-6">
            ...
            <Tabs defaultValue="general" className="space-y-6">
                ...
                {/* Playback Settings */}
                <TabsContent value="playback" className="space-y-6 animate-fade-in">
                    <Card>
                        <CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Manage audio and subtitle preferences</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                ...
                <TabsContent value="downloads" className="space-y-6 animate-fade-in">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Manage how content is downloaded</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Select value={downloadQuality} onValueChange={setDownloadQuality}>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="high">High (Uses more storage)</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-sm text-muted-foreground">Only download content when connected to Wi-Fi</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <Label htmlFor="auto-delete">Auto-delete watched downloads</Label>
                                    <p className="text-sm text-muted-foreground">
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            This will delete all downloaded content from your device. This action cannot be undone.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                                        <AlertDialogAction onClick={clearDownloads}>Clear Downloads</AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
                            </AlertDialog>
                        </CardFooter>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Switch id="watch-history" checked={saveWatchHistory} onCheckedChange={setSaveWatchHistory} />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch id="analytics" checked={collectAnalytics} onCheckedChange={setCollectAnalytics} />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch id="recommendations" checked={showRecommendations} onCheckedChange={setShowRecommendations} />
                            </div>
                        </CardContent>
                        <CardFooter>
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            This will remove all your viewing history and reset your progress on all content. This action
                                            cannot be undone.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                                        <AlertDialogAction onClick={clearWatchHistory}>Clear History</AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
                            </AlertDialog>
                        </CardFooter>
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-4">
                                {[
                                    ...
                                    { name: "iPhone 13", lastActive: "2 hours ago", current: false },
                                    { name: "Samsung TV", lastActive: "Yesterday", current: false },
                                ].map((device, index) => (
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-4">
                                This will reset all your preferences to their default values. Your account information and content will
                                not be affected.
                            </p>
                            <AlertDialog>
                                <AlertDialogTrigger asChild>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            This will reset all your preferences to their default values. Your account information and content
                                            will not be affected. This action cannot be undone.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                                        <AlertDialogAction onClick={resetAllSettings}>Reset Settings</AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
                            </AlertDialog>
                        </CardContent>
