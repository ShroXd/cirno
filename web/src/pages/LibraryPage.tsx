...
import { Play, SlidersHorizontal, Search, Film, Tv, Star, ChevronDown } from "lucide-react"
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
export default function LibraryPage() {
    ...
    useEffect(() => {
        ...
        if (sortBy === "recently-added") {
            ...
            result.sort((a, b) => {
                const yearA = typeof a.year === "string" ? Number.parseInt(a.year.split("-")[0]) : a.year
                const yearB = typeof b.year === "string" ? Number.parseInt(b.year.split("-")[0]) : b.year
                return yearB - yearA
            })
        ...
        <div className="container mx-auto py-6 px-4 md:px-6">
                ...
                <div className="flex gap-2">
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => setSortBy("year-desc")}>Newest</DropdownMenuItem>
                            <DropdownMenuItem onClick={() => setSortBy("year-asc")}>Oldest</DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
            ...
            {filteredContent.length === 0 ? (
                <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-6">We couldn't find any content matching your search criteria.</p>
                    <Button
                        onClick={() => {
                            setSearchQuery("")
                            setActiveTab("all")
                ...
                <CardContent className="p-3">
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{item.type === "movie" ? item.year : item.year}</p>
                        </div>
