...
import { Compass, Film, Home, Library, ListPlus, PlaySquare, Plus, Search, Settings, Star } from "lucide-react"
import {
    Dialog,
    DialogContent,
    DialogDescription,
                ...
                <SidebarGroup>
                    ...
                    <SidebarGroupContent>
                        <SidebarMenu>
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild isActive={location.pathname === "/movies"}>
                                    <Link to="/movies">
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild isActive={location.pathname === "/tv-shows"}>
                                    <Link to="/tv-shows">
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild isActive={location.pathname === "/favorites"}>
                                    <Link to="/favorites">
